...
// Mon Nov 24 14:29:49 2025 by ROOT version 6.32.04
// from TTree Events/Events
// found on file: /data/shuangyuan/dataset/RunIII2024Summer24/QCD_Bin-PT-600to800_TuneCP5_13p6TeV_pythia8/00f8eb69-785d-427a-97cc-d046d66bd686.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSe[4];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSjet[4];   //[nboostedTau]
   Float_t         boostedTau_rawBoostedDeepTauRunIIv2p0VSmu[4];   //[nboostedTau]
   ...
   Int_t           nCorrT1METJet;
   Float_t         CorrT1METJet_EmEF[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_area[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_eta[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrDeltaEta[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrDeltaPhi[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_muonSubtrFactor[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_phi[10];   //[nCorrT1METJet]
   Float_t         CorrT1METJet_rawMass[10];   //[nCorrT1METJet]
   ...
   Bool_t          Electron_isEB[6];   //[nElectron]
   Bool_t          Electron_isEcalDriven[6];   //[nElectron]
   ...
   Bool_t          Electron_mvaIso_WPHZZ[6];   //[nElectron]
   ...
   Short_t         Electron_seediEtaOriX[6];   //[nElectron]
   Short_t         Electron_seediPhiOriY[6];   //[nElectron]
   ...
   Float_t         Electron_PreshowerEnergy[6];   //[nElectron]
   ...
   Float_t         Electron_ecalEnergy[6];   //[nElectron]
   Float_t         Electron_ecalEnergyError[6];   //[nElectron]
   Float_t         Electron_energyErr[6];   //[nElectron]
   Float_t         Electron_eta[6];   //[nElectron]
   Float_t         Electron_fbrem[6];   //[nElectron]
   Float_t         Electron_gsfTrketaMode[6];   //[nElectron]
   Float_t         Electron_gsfTrkpMode[6];   //[nElectron]
   Float_t         Electron_gsfTrkpModeErr[6];   //[nElectron]
   Float_t         Electron_gsfTrkphiMode[6];   //[nElectron]
   Float_t         Electron_hoe[6];   //[nElectron]
   Float_t         Electron_ip3d[6];   //[nElectron]
   Float_t         Electron_jetDF[6];   //[nElectron]
   ...
   Float_t         Electron_promptMVA[6];   //[nElectron]
   Int_t           nFatJet;
   ...
   Float_t         FatJet_globalParT3_QCD[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWev[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWmv[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWq[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWqq[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_TopbWtauhv[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_WvsQCD[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWW3q[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWW4q[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWWqqev[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_XWWqqmv[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xbb[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xcc[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xcs[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xqq[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtaue[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtauh[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_Xtauhtaum[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_massCorrGeneric[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_massCorrX2p[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassTopvsQCD[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassWvsQCD[6];   //[nFatJet]
   Float_t         FatJet_globalParT3_withMassZvsQCD[6];   //[nFatJet]
   ...
   Int_t           nFatJetPFCand;
   Int_t           FatJetPFCand_pfCandIdx[312];   //[nFatJetPFCand]
   Int_t           FatJetPFCand_jetIdx[312];   //[nFatJetPFCand]
   Int_t           nFsrPhoton;
   ...
   Int_t           nGenPart;
   Short_t         GenPart_genPartIdxMother[140];   //[nGenPart]
   UShort_t        GenPart_statusFlags[140];   //[nGenPart]
   Int_t           GenPart_pdgId[140];   //[nGenPart]
   Int_t           GenPart_status[140];   //[nGenPart]
   Float_t         GenPart_eta[140];   //[nGenPart]
   Float_t         GenPart_mass[140];   //[nGenPart]
   Float_t         GenPart_phi[140];   //[nGenPart]
   Float_t         GenPart_pt[140];   //[nGenPart]
   Float_t         GenPart_iso[140];   //[nGenPart]
   Int_t           nGenProton;
   ...
   Short_t         IsoTrack_charge[8];   //[nIsoTrack]
   Short_t         IsoTrack_fromPV[8];   //[nIsoTrack]
   ...
   Int_t           nJet;
   UChar_t         Jet_chMultiplicity[18];   //[nJet]
   UChar_t         Jet_nConstituents[18];   //[nJet]
   UChar_t         Jet_nElectrons[18];   //[nJet]
   UChar_t         Jet_nMuons[18];   //[nJet]
   UChar_t         Jet_nSVs[18];   //[nJet]
   UChar_t         Jet_neMultiplicity[18];   //[nJet]
   Short_t         Jet_electronIdx1[18];   //[nJet]
   Short_t         Jet_electronIdx2[18];   //[nJet]
   Short_t         Jet_muonIdx1[18];   //[nJet]
   Short_t         Jet_muonIdx2[18];   //[nJet]
   Short_t         Jet_svIdx1[18];   //[nJet]
   Short_t         Jet_svIdx2[18];   //[nJet]
   Int_t           Jet_hfadjacentEtaStripsSize[18];   //[nJet]
   Int_t           Jet_hfcentralEtaStripSize[18];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorr[18];   //[nJet]
   Float_t         Jet_PNetRegPtRawCorrNeutrino[18];   //[nJet]
   Float_t         Jet_PNetRegPtRawRes[18];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorr[18];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawCorrNeutrino[18];   //[nJet]
   Float_t         Jet_UParTAK4RegPtRawRes[18];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorr[18];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawCorrNeutrino[18];   //[nJet]
   Float_t         Jet_UParTAK4V1RegPtRawRes[18];   //[nJet]
   Float_t         Jet_area[18];   //[nJet]
   Float_t         Jet_btagDeepFlavB[18];   //[nJet]
   Float_t         Jet_btagDeepFlavCvB[18];   //[nJet]
   Float_t         Jet_btagDeepFlavCvL[18];   //[nJet]
   Float_t         Jet_btagDeepFlavQG[18];   //[nJet]
   Float_t         Jet_btagPNetB[18];   //[nJet]
   Float_t         Jet_btagPNetCvB[18];   //[nJet]
   Float_t         Jet_btagPNetCvL[18];   //[nJet]
   Float_t         Jet_btagPNetCvNotB[18];   //[nJet]
   Float_t         Jet_btagPNetQvG[18];   //[nJet]
   Float_t         Jet_btagPNetTauVJet[18];   //[nJet]
   Float_t         Jet_btagUParTAK4B[18];   //[nJet]
   Float_t         Jet_btagUParTAK4CvB[18];   //[nJet]
   Float_t         Jet_btagUParTAK4CvL[18];   //[nJet]
   Float_t         Jet_btagUParTAK4CvNotB[18];   //[nJet]
   Float_t         Jet_btagUParTAK4Ele[18];   //[nJet]
   Float_t         Jet_btagUParTAK4Mu[18];   //[nJet]
   Float_t         Jet_btagUParTAK4QvG[18];   //[nJet]
   Float_t         Jet_btagUParTAK4SvCB[18];   //[nJet]
   Float_t         Jet_btagUParTAK4SvUDG[18];   //[nJet]
   Float_t         Jet_btagUParTAK4TauVJet[18];   //[nJet]
   Float_t         Jet_btagUParTAK4UDG[18];   //[nJet]
   Float_t         Jet_btagUParTAK4probb[18];   //[nJet]
   Float_t         Jet_btagUParTAK4probbb[18];   //[nJet]
   Float_t         Jet_chEmEF[18];   //[nJet]
   Float_t         Jet_chHEF[18];   //[nJet]
   Float_t         Jet_eta[18];   //[nJet]
   Float_t         Jet_hfEmEF[18];   //[nJet]
   Float_t         Jet_hfHEF[18];   //[nJet]
   Float_t         Jet_hfsigmaEtaEta[18];   //[nJet]
   Float_t         Jet_hfsigmaPhiPhi[18];   //[nJet]
   Float_t         Jet_mass[18];   //[nJet]
   Float_t         Jet_muEF[18];   //[nJet]
   Float_t         Jet_muonSubtrDeltaEta[18];   //[nJet]
   Float_t         Jet_muonSubtrDeltaPhi[18];   //[nJet]
   Float_t         Jet_muonSubtrFactor[18];   //[nJet]
   Float_t         Jet_neEmEF[18];   //[nJet]
   Float_t         Jet_neHEF[18];   //[nJet]
   Float_t         Jet_phi[18];   //[nJet]
   Float_t         Jet_pt[18];   //[nJet]
   Float_t         Jet_puIdDisc[18];   //[nJet]
   ...
   Float_t         GenMET_pt;
   Int_t           nMuon;
   UChar_t         Muon_bestTrackType[11];   //[nMuon]
   ...
   Float_t         Muon_softMvaRun3[11];   //[nMuon]
   Float_t         Muon_tkRelIso[11];   //[nMuon]
   Float_t         Muon_tuneP_charge[11];   //[nMuon]
   Float_t         Muon_tuneP_pterr[11];   //[nMuon]
   Float_t         Muon_tunepRelPt[11];   //[nMuon]
   Float_t         Muon_bsConstrainedChi2[11];   //[nMuon]
   Float_t         Muon_bsConstrainedPt[11];   //[nMuon]
   Float_t         Muon_bsConstrainedPtErr[11];   //[nMuon]
   Float_t         Muon_mvaLowPt[11];   //[nMuon]
   Float_t         Muon_pnScore_heavy[11];   //[nMuon]
   Float_t         Muon_pnScore_light[11];   //[nMuon]
   Float_t         Muon_pnScore_prompt[11];   //[nMuon]
   Float_t         Muon_pnScore_tau[11];   //[nMuon]
   Float_t         Muon_promptMVA[11];   //[nMuon]
   Int_t           nPFCand;
   Int_t           PFCand_pdgId[312];   //[nPFCand]
   Float_t         PFCand_eta[312];   //[nPFCand]
   Float_t         PFCand_mass[312];   //[nPFCand]
   Float_t         PFCand_phi[312];   //[nPFCand]
   Float_t         PFCand_pt[312];   //[nPFCand]
   Float_t         PFMET_covXX;
   Float_t         PFMET_covXY;
   Float_t         PFMET_covYY;
   Float_t         PFMET_phi;
   ...
   Int_t           nPhoton;
   UChar_t         Photon_cutBased[9];   //[nPhoton]
   Bool_t          Photon_electronVeto[9];   //[nPhoton]
   Bool_t          Photon_hasConversionTracks[9];   //[nPhoton]
   ...
   Short_t         Photon_electronIdx[9];   //[nPhoton]
   Short_t         Photon_jetIdx[9];   //[nPhoton]
   Short_t         Photon_seediEtaOriX[9];   //[nPhoton]
   Short_t         Photon_seediPhiOriY[9];   //[nPhoton]
   Int_t           Photon_vidNestedWPBitmap[9];   //[nPhoton]
   Float_t         Photon_ecalPFClusterIso[9];   //[nPhoton]
   Float_t         Photon_energyErr[9];   //[nPhoton]
   Float_t         Photon_energyRaw[9];   //[nPhoton]
   Float_t         Photon_esEffSigmaRR[9];   //[nPhoton]
   Float_t         Photon_esEnergyOverRawE[9];   //[nPhoton]
   Float_t         Photon_eta[9];   //[nPhoton]
   Float_t         Photon_etaWidth[9];   //[nPhoton]
   Float_t         Photon_haloTaggerMVAVal[9];   //[nPhoton]
   Float_t         Photon_hcalPFClusterIso[9];   //[nPhoton]
   Float_t         Photon_hoe[9];   //[nPhoton]
   Float_t         Photon_hoe_PUcorr[9];   //[nPhoton]
   Float_t         Photon_hoe_Tower[9];   //[nPhoton]
   Float_t         Photon_mvaID[9];   //[nPhoton]
   Float_t         Photon_pfChargedIso[9];   //[nPhoton]
   Float_t         Photon_pfChargedIsoPFPV[9];   //[nPhoton]
   Float_t         Photon_pfChargedIsoWorstVtx[9];   //[nPhoton]
   Float_t         Photon_pfPhoIso03[9];   //[nPhoton]
   Float_t         Photon_pfRelIso03_all_quadratic[9];   //[nPhoton]
   Float_t         Photon_pfRelIso03_chg_quadratic[9];   //[nPhoton]
   Float_t         Photon_phi[9];   //[nPhoton]
   Float_t         Photon_phiWidth[9];   //[nPhoton]
   Float_t         Photon_pt[9];   //[nPhoton]
   Float_t         Photon_r9[9];   //[nPhoton]
   Float_t         Photon_s4[9];   //[nPhoton]
   Float_t         Photon_sieie[9];   //[nPhoton]
   Float_t         Photon_sieip[9];   //[nPhoton]
   Float_t         Photon_sipip[9];   //[nPhoton]
   Float_t         Photon_superclusterEta[9];   //[nPhoton]
   Float_t         Photon_trkSumPtHollowConeDR03[9];   //[nPhoton]
   Float_t         Photon_trkSumPtSolidConeDR04[9];   //[nPhoton]
   Float_t         Photon_x_calo[9];   //[nPhoton]
   Float_t         Photon_y_calo[9];   //[nPhoton]
   Float_t         Photon_z_calo[9];   //[nPhoton]
   Int_t           Pileup_nPU;
   ...
   Int_t           nSubJet;
   Float_t         SubJet_UParTAK4RegPtRawCorr[13];   //[nSubJet]
   Float_t         SubJet_UParTAK4RegPtRawCorrNeutrino[13];   //[nSubJet]
   Float_t         SubJet_UParTAK4RegPtRawRes[13];   //[nSubJet]
   Float_t         SubJet_UParTAK4V1RegPtRawCorr[13];   //[nSubJet]
   Float_t         SubJet_UParTAK4V1RegPtRawCorrNeutrino[13];   //[nSubJet]
   Float_t         SubJet_UParTAK4V1RegPtRawRes[13];   //[nSubJet]
   Float_t         SubJet_area[13];   //[nSubJet]
   Float_t         SubJet_btagDeepFlavB[13];   //[nSubJet]
   Float_t         SubJet_btagUParTAK4B[13];   //[nSubJet]
   ...
   Short_t         Tau_decayModeUParT[4];   //[nTau]
   ...
   Float_t         Tau_rawUParTVSe[4];   //[nTau]
   Float_t         Tau_rawUParTVSjet[4];   //[nTau]
   Float_t         Tau_rawUParTVSmu[4];   //[nTau]
   Int_t           nTrackGenJetAK4;
   Float_t         TrackGenJetAK4_eta[16];   //[nTrackGenJetAK4]
   Float_t         TrackGenJetAK4_phi[16];   //[nTrackGenJetAK4]
   Float_t         TrackGenJetAK4_pt[16];   //[nTrackGenJetAK4]
   Int_t           nTrigObj;
   Short_t         TrigObj_l1charge[108];   //[nTrigObj]
   UShort_t        TrigObj_id[108];   //[nTrigObj]
   Int_t           TrigObj_l1iso[108];   //[nTrigObj]
   ULong64_t       TrigObj_filterBits[108];   //[nTrigObj]
   Float_t         TrigObj_pt[108];   //[nTrigObj]
   Float_t         TrigObj_eta[108];   //[nTrigObj]
   Float_t         TrigObj_phi[108];   //[nTrigObj]
   Float_t         TrigObj_l1pt[108];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[108];   //[nTrigObj]
   Float_t         TrigObj_l2pt[108];   //[nTrigObj]
   Float_t         TrkMET_phi;
   Float_t         TrkMET_pt;
   ...
   Float_t         Electron_IPx[6];   //[nElectron]
   Float_t         Electron_IPy[6];   //[nElectron]
   Float_t         Electron_IPz[6];   //[nElectron]
   Float_t         Electron_ipLengthSig[6];   //[nElectron]
   UChar_t         FatJet_hadronFlavour[6];   //[nFatJet]
   Short_t         FatJet_genJetAK8Idx[6];   //[nFatJet]
   UChar_t         GenJetAK8_hadronFlavour[7];   //[nGenJetAK8]
   UChar_t         GenJetAK8_nBHadrons[7];   //[nGenJetAK8]
   UChar_t         GenJetAK8_nCHadrons[7];   //[nGenJetAK8]
   ...
   Short_t         Muon_genPartIdx[11];   //[nMuon]
   Float_t         Muon_IPx[11];   //[nMuon]
   Float_t         Muon_IPy[11];   //[nMuon]
   Float_t         Muon_IPz[11];   //[nMuon]
   Float_t         Muon_ipLengthSig[11];   //[nMuon]
   UChar_t         Photon_genPartFlav[9];   //[nPhoton]
   Short_t         Photon_genPartIdx[9];   //[nPhoton]
   UChar_t         SubJet_hadronFlavour[13];   //[nSubJet]
   UChar_t         SubJet_nBHadrons[13];   //[nSubJet]
   UChar_t         SubJet_nCHadrons[13];   //[nSubJet]
   Short_t         SubJet_subGenJetAK8Idx[13];   //[nSubJet]
   ...
   Bool_t          Tau_hasRefitSV[4];   //[nTau]
   Float_t         Tau_IPx[4];   //[nTau]
   Float_t         Tau_IPy[4];   //[nTau]
   Float_t         Tau_IPz[4];   //[nTau]
   Float_t         Tau_ipLengthSig[4];   //[nTau]
   Float_t         Tau_refitSVchi2[4];   //[nTau]
   Float_t         Tau_refitSVcov00[4];   //[nTau]
   Float_t         Tau_refitSVcov10[4];   //[nTau]
   Float_t         Tau_refitSVcov11[4];   //[nTau]
   Float_t         Tau_refitSVcov20[4];   //[nTau]
   Float_t         Tau_refitSVcov21[4];   //[nTau]
   Float_t         Tau_refitSVcov22[4];   //[nTau]
   Float_t         Tau_refitSVx[4];   //[nTau]
   Float_t         Tau_refitSVy[4];   //[nTau]
   Float_t         Tau_refitSVz[4];   //[nTau]
   Bool_t          L1_AXO_Loose;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data/shuangyuan/dataset/RunIII2024Summer24/QCD_Bin-PT-600to800_TuneCP5_13p6TeV_pythia8/00f8eb69-785d-427a-97cc-d046d66bd686.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/data/shuangyuan/dataset/RunIII2024Summer24/QCD_Bin-PT-600to800_TuneCP5_13p6TeV_pythia8/00f8eb69-785d-427a-97cc-d046d66bd686.root");
      }
